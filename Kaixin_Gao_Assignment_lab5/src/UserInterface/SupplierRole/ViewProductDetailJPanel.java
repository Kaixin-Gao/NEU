...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel upc, Product p) {
        ...
        txtAva.setText(String.valueOf(p.getAvail()));
    }
    ...
    private void initComponents() {
        ...
        txtAva.setEditable(false);
        txtAva.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtAva.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        add(txtAva, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 159, -1));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        product.setAvail(Integer.parseInt(txtAva.getText()));
