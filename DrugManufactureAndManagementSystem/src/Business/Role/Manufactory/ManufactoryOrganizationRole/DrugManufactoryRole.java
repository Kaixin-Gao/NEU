 ...
 * @author zhang
 */
public class DrugManufactoryRole extends Role{
     @Override
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business) {
        return new DrugManufactoryWorkAreaJPanel( userProcessContainer, account, (DrugManufactoryOrganization) organization,  enterprise,business);
    }
}
